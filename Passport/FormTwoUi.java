 ...
 * @author acer
 */
public class FormTwoUi extends javax.swing.JFrame {
    ...
    public FormTwoUi() {
        initComponents();
        setTitle("Application Form – Document Submiting");
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Document Submiting ");
    ...
    private void UploadActionPerformed(java.awt.event.ActionEvent evt) {                                       
       ...
       try {obj.Upload(Nic,Username, NicImagePath, BirthCertificateImagePath, PassportPhotoImagePath);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTwoUi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
